...
class ForwardKinematics:
    ...
    def __init__(self):  
        ...
        # and another for visualizing a target pose (to see whether your calculations are fine)
    ...
    # the following function creates a POSE message from a homogeneous matrix
    ...
    # the ROS message type POSE uses quaternions for the orientation
